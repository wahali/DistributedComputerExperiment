package Exercise.exercise1.PasswordEncryption;
...
public class PasswordEncryption {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("passwd " + password + "  " + password.length());
            System.out.println("salt " + salt + "  " + salt.length());
            System.out.println("cipertext " + ciphertext + "  " + ciphertext.length());
            if (result) {
